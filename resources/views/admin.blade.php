                ...
                <div class="list-group">
                  <a href="#" class="list-group-item active">
                      <i class="fa fa-cogs"></i>Profil Beranda</a>
                          <a href="/perusahaan/1/edit" class="list-group-item"><i class="fa fa-home"></i>INPUT PROFIL PERUSAHAAN</a>
                          <a href="/chart" class="list-group-item"><i class="fa fa-home"></i>BAGIAN</a>
